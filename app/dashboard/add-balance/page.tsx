...
const ADD_BALANCE_FALLBACK_AR: Record<AddBalanceMsgKey, string> = {
  title: "شحن الرصيد",
  subtitle: "اختر طريقة الدفع ثم اتبع التعليمات",
  methodTitle: "فودافون كاش",
  transferInstruction: "حوّل المبلغ المطلوب إلى رقم المحفظة التالي:",
  confirmationNote: "بعد التحويل، أرسل لقطة شاشة تأكيد التحويل على واتساب إلى الرقم",
  waitingNote: "بعد إرسال لقطة التأكيد، سيبقى رصيدك قيد المراجعة ويُضاف في أقرب وقت.",
  whatsappButton: "إرسال لقطة التأكيد على واتساب",
};
...
function resolveAddBalanceCopy(
  ...
  return t(`${ABS}.${key}`, ADD_BALANCE_FALLBACK_AR[key]);
}
